...
const Home = () => {
    ...
    return (
        <div className='bg-[rgba(41,68,111,1)]'>
            <Navbar></Navbar>
            ...
            <div className='grid grid-cols-3 gap-4 px-36'>
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-end">
                    <button className="btn btn-primary" onClick={() => handleDetails("robu")}>See more</button>
                    </div>
                </div>
                </div>
...
#20YearsGlory</p>
                    <div className="card-actions justify-end">
                    <button className="btn btn-primary" onClick={() => handleDetails("BizzBee")}>See more</button>
                    </div>
                </div>
                </div>
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-end">
                    <button className="btn btn-primary" onClick={() => handleDetails("bucuc")}>See more</button>
                    </div>
                </div>
                </div>
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-end">
                    <button className="btn btn-primary" onClick={() => handleDetails("budtf")}>See more</button>
                    </div>
                </div>
                </div>
...
<div className='flex justify-around py-9'>
            <div className='rounded-lg  w-96 ml-10'>
                <div className='bg-[#2E77D0] pt-5 h-20  text-center items-center rounded-tr-badge '>
                    <h2 className='text-3xl text-blue-50 '>CLUB NEWS</h2>
                </div>
                    
                    <div className="bg-blue-300 w-96 p-5">
  <div className="bg-blue-400 p-2 my-2">
    <p>Title: Robotics Club Workshop</p>
    <h1>Date: 12.01.2024</h1>
    <p>Details: Join us for an introductory workshop on robotics and automation.</p>
  </div>
  <div className="bg-blue-400 p-2 my-2">
    <p>Title: Cultural Club - Drama Night</p>
    <h1>Date: 20.01.2024</h1>
    <p>Details: Enjoy an evening of plays and performances celebrating diverse cultures.</p>
  </div>
  <div className="bg-blue-400 p-2 my-2">
    <p>Title: Adventure Club - Hiking Trip</p>
    <h1>Date: 22.01.2024</h1>
    <p>Details: Explore the hills with us on an exciting hiking adventure!</p>
  </div>
  <div className="bg-blue-400 p-2 my-2">
    <p>Title: Computer Club - Hackathon</p>
    <h1>Date: 25.01.2024</h1>
    <p>Details: Participate in our annual hackathon and showcase your coding skills.</p>
  </div>
  <div className="bg-blue-400 p-2 my-2">
    <p>Title: Robotics Club - Tech Talk</p>
    <h1>Date: 28.01.2024</h1>
    <p>Details: Attend a talk by industry experts on robotics and AI advancements.</p>
  </div>
</div>
            </div>
            <div className='w-[800px]'>
                ...
                <div className=''> 
                    <div className='bg-[#2E77D0] p-0 h-11 text-center items-center  '>
